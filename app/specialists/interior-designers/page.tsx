// app/specialists/interior-designers/page.tsx (App Router)
// ИЛИ
// pages/specialists/interior-designers/index.tsx (Pages Router)
...
export default function InteriorDesignersPage() {
  ...
  const allDesigners = specialists.filter(
    (s) => s.category === "interior-designers",
  );
  ...
  // Фильтрация и сортировка дизайнеров
    ...
    if (searchTerm) {
      filtered = filtered.filter(
        (designer) =>
          ...
          designer.firm.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <section className="container mx-auto relative px-4 sm:px-6 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-[#666666] text-sm sm:text-base">
          Профессиональные дизайнеры интерьера для создания уютного и стильного
          пространства
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Поиск дизайнеров по имени, компании или описанию..."
            value={searchTerm}
      ...
      <div className="mb-4 flex justify-between items-center">
        <p className="text-sm text-[#666666]">
          Найдено: {filteredAndSortedDesigners.length} дизайнеров
        </p>
        {searchTerm && (
      ...
      {filteredAndSortedDesigners.length > 0 ? (
        ...
        <div className="text-center py-12">
          <div className="text-[#666666] mb-4">
            ...
            <p className="text-lg font-medium">Дизайнеры не найдены</p>
